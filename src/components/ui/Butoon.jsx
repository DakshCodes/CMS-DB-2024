...
const Butoon = ({ title }) => {
    return (
        <button className="overflow-hidden  w-28 p-2 h-[2.5rem] bg-black text-white border-none rounded-md  font-bold cursor-pointer relative  group">
            ...
            <span className=" z-40 absolute left-8 top-[0.6rem] text-[0.910rem]">{title}</span>
        </button>
    )
}
